            ...
            VStack(alignment: .center, spacing: 0) {
                Form {
                    ...
                    Section(header: Text("Follow us on social media")) {
                        ...
                        FormRowLinkView(icon: "link", color: Color.blue, text: "Twitter", link: "https://twitter.com/stsmall1985")
                        FormRowLinkView(icon: "play.rectangle", color: Color.green, text: "Courses", link: "https://yandex.ru")
                    }
                    .padding(.vertical, 3)
                    ...
                    Section(header: Text("About the application")) {
                        ...
                        FormRowStaticView(icon: "keyboard", firstText: "Developer", secondText: "Stanly Shiyanovskiy")
